...
Link:
[My Shorthand Wireframe](https://carnegiemellon.shorthandstories.com/c323c075-7a7b-4534-81d6-db28712a289d/)
...
Note:  I had originally used my story arc to conduct preliminary research with classmates that led me to seek out information on creating a similar timeline on coal mining in Southwestern Pennsylvania.  Then, I spoke to friends who suggested I keep the story focused on Limburg.  Based on their feedback, I redid my storyframe, eliminating Pittsburgh, but something was still missing.  However, after the wonderful feedback of my classmates in our in person critique session on Monday, February 21, I created a brand new wireframe based on an entirely new way of presenting my story!  Luckily, with the addition of Tuesday, I was able to conduct my interviews, receive excellent feedback, and plan for my next steps!
...
Mine Map:  Since I am a dual GIS/TSWD student at the moment, I know Professor Goranson knows I can make a map, so I saved myself the time and used a prototype existing map to see if my interviewees appreciated it before taking the time to make it myself.  Since mapmaking is a form of a stretch goal for this course, I am under the assumption that is acceptable for Part II of the project.

GDP/Mine Production Data:  Originally, I had planned to have a graph showing GDP growth data and mine production data.  Since I was nearly convinced by discussion with classmates that this would not only be considered too much information, but it would also be just shoving data at the story for the sake of data, I asked my interviewees about it and they also told me it was too much information.  I will not be moving forward with that data.

7 out of 10:  My goal was to keep it simple and to the point and I'm hoping I succeeded!

Alluvial Diagram:  I was so excited when we did the alluvial diagram in class because it unlock my ability to show the transformation in employment between 1965 and 1972 for miners and office workers from the 11 Limburg mines!  Although I still have a few questions about fine tuning the labels, I am very happy with my first alluvial diagram.
...
|  Quality of Evidence  |  Knowing that the text will be primarily providing the story, not adding statistics or providing additional geographic/economic context, is there anything you would add?  Do the supporting images and charts help provide evidence and context for the story?  Are there any images or charts that feel unnecessary? Should I include a chart showing Dutch GDP growth or mine production statistics to supplement the story?  |
...
|-------------------------|--------------------------------|-------------|-------------|
| "Is it a story?" Questions      | Quote:  The Dutch went from having ads in Italy to me having work trips in Italy where I work with a Dutch man who left the Netherlands.  Paraphrase:  I think you capture nicely how the Netherlands went from being a major coal powerhouse to having no mines left in Limburg to eventual honoring their coal past.  It works.  |  Paraphrase:  The story works well, but make sure you specify what the Dutch did between 1965 and today to make it work.  The job chart shows some of what happened, but you need to show the how"  |  Paraphrase:  I would probably tell someone that they shouldn't attach their identity to their job.  On a more serious note, I would say that this is an argument for why a social safety net is important, especially when the "robots are coming for our jobs"     |
...
|------------------------------------------|---------------------------------------------------------------------------------|
| Drop the GDP and coal mining data?   | Although my graph was delayed due to me continuously messing up the data in Excel, the overwhelming consensus from my classmates and my interviews was that it's unnecessary and feels like adding data to add data.  For this reason, I plan to find better, perhaps simpler, and more relevant statistics to add.|
...
| Fix the scrolling images   | Although minor, I ended up just telling my interviewees that I couldn't get the scrolling images in my introductory section to work since I didn't want it to be a distraction. They barely seem to be moving and when they do, it's very stiff.  I'll be sure to ask about it in class, after class, or in office hours.  |
